    ...
    >
      ...
      <div className="w-[min(100%,38rem)] px-4">
        <p className="mb-20 mt-6 text-gray-700 dark:text-white/80">
          ...
          <a className="underline" href="mailto:rishantvik@gmail.com">
            rishantvik@gmail.com
          </a>{" "}
          or through this form.
        </p>
        <div className="mb-8 text-gray-700 dark:text-white/80">
          <p>Phone: <a href="tel:+918340173019" className="underline">+91 8340173019</a></p>
          <p>Location: Ranchi, Jharkhand</p>
          <p>LinkedIn: <a href="https://www.linkedin.com/in/rishant-vikramaditya-a23061254" target="_blank" className="underline">Rishant Vikramaditya</a></p>
        </div>
